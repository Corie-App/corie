...
import { generateThemeAction, updateThemeAction } from '../actions';

export default function Theme({ productId, announcementId }: { productId: string; announcementId: string }) {
	...
	const { executeFormAction, isPending } = useServerAction(updateThemeAction, {
		onSuccess() {
	...
	return (
		<AccordionItem value='theme' className='border-b-0 px-3'>
